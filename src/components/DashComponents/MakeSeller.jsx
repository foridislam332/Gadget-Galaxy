...
const MakeSeller = ({ userData, handleUpdateRole }) => {
    ...
    useEffect(() => {
        ...
        const filteredAdmin = userData.filter(user => user.role === 'seller');
        setSellerData(filteredAdmin)
    }, [userData]);
    ...
    const handleMakeAdmin = () => {
        ...
        handleUpdateRole(selectUser.value, 'seller')
    }
    return (
        <div>
            <div className="flex items-end gap-2">
                <div>
                    <h2 className="font-medium text-gray">Make Seller:</h2>
                    <Select
                        value={selectUser}
